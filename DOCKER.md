...
Reemplaza `<DOCKERHUB_USER>` por tu usuario de Docker Hub.
...
# En Jetson (si tu runtime usa nvidia-container-runtime)
...
## Notas rápidas
- Si tu host usa Docker >= 19.03 con el soporte `--gpus`, usa `--gpus all` para exponer GPUs al contenedor.
...
Con esto podrás construir localmente las imágenes, subirlas a Docker Hub, descargarlas en otra máquina y ejecutar el servidor dentro de contenedores.
